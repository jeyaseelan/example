...
DatePickerControl.todayText       = "Close";
DatePickerControl.buttonTitle     = "Date";
...
DatePickerControl.init = function()
{
	...
	for (i=0; i<inputsLength; i++){
		if (inputControls[i].type.toLowerCase() == "text"){
    		...
    		var dcheck   = editctrl.getAttribute("id");
			var setEvents = false;
			
			// Set start date and End date
			if(dcheck=="DPC_calendar")
			{
			DatePickerControl.buttonTitle     = "Start Date";
			}
			else
			{
			DatePickerControl.buttonTitle     = "End Date";
	        }
...
DatePickerControl.createButton = function(input, useId)
{
	...
	*/
	...
	calButton.src = "/images/calendar_icon.gif";
	if (this.buttonPosition == "in"){
